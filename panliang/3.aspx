<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="3.aspx.cs" Inherits="panliang._3" %>
    ...
    <form id="form1" runat="server">
       <div>
            ...
            <div class="header">
                ...
                <h1 >水果商店</h1></div>
                <div>
                <h4 style="text-align:center"><asp:Label ID="Label1" runat="server" Text="Label"></asp:Label>的订单列表</h4>
        </div>
            

        
                 <div style="text-align:right">
            <asp:LinkButton ID="LinkButton1" runat="server" BorderStyle="None" ForeColor="Blue" PostBackUrl="~/order1.aspx">返回</asp:LinkButton>
        &nbsp;
        ...
        <div >
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Width="1454px" BackColor="#CCFFFF" BorderColor="#CCFFCC" HorizontalAlign="Center">
                <Columns>
                    <asp:BoundField DataField="ida" HeaderText="订单编号" />
                    <asp:BoundField DataField="resname" HeaderText="收货人姓名" />
